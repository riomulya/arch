          ...
          >
            <Link href="/" className="flex items-center space-x-2">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-gray-600">Solusi Konstruksi & Teknis</p>
              </div>
            </Link>
          </motion.div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white rounded-lg shadow-lg mt-2">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="text-gray-700 hover:text-blue-600 hover:bg-gray-50 block px-3 py-2 text-base font-medium rounded-md transition-colors duration-300"
